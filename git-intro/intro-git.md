...
Navigate to to this file for instructions on [installing Git](https://gitlab.com/revature_training/git-team/-/blob/patch-6/modules/installation/git-windows-install.md)
